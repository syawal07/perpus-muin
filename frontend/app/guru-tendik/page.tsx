...
export default async function GuruTendikPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="bg-brand-blue pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <nav className="flex mb-4 text-white/60 text-sm font-medium gap-2">
            ...
            <span>/</span>
            <span className="text-brand-yellow">Guru & Tendik</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white">Daftar Pendidik & Tenaga Kependidikan</h1>
          <p className="text-white/80 mt-4 max-w-2xl text-lg">
            Profil lengkap seluruh asatidz dan staf yang melayani dan membimbing santri di Madrasah Mu&apos;allimin Muhammadiyah Yogyakarta.
          </p>
        </div>
      </div>

      <StaffSection staffs={staffs} showFilters={true} />
    </main>
  );
}